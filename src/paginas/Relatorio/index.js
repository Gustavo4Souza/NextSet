...
import { View, Text, TextInput, TouchableOpacity, ScrollView, StyleSheet, Dimensions, Image, Alert } from "react-native";
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 50 }}>
      ...
      <View style={styles.goalsContainer}>
        {["Emagrecer", "Condição Física", "Ganho de Massa Muscular"].map((item) => (
          ...
          >
            ...
            >
              <Text
                style={[styles.goalText, goal === item && styles.goalTextSelected]}
              >
                {item}
              </Text>
            </LinearGradient>
      ...
      <View style={styles.expectationContainer}>
        <TouchableOpacity
          style={styles.expectationButton}
          onPress={() => setExpectation("rápido")}
        >
          <Ionicons
